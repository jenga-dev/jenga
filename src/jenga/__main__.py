...
@app.command()
def run_full_build(
    build_file_path: Annotated[str, typer.Argument(
        help="The path to the build file.")]
) -> None:
...
def resume_partial_build(
    build_file_path: Annotated[str, typer.Argument(
        help="The path to the build file.")],
    state_file_path: Annotated[Optional[str], typer.Option(help=(
...
def convert_weidu_log_to_json_build_file(
    weidu_log_path: Annotated[str, typer.Argument(
        help="The path to the WeiDU log file.")],
    build_file_path: Annotated[Optional[str], typer.Option(help=(
...
def convert_build_file_to_build_order_file(
    build_file_path: Annotated[str, typer.Argument(
        help="The path to the Jenga build file.")],
...
def reorder_build_file_by_build_order_file(
    build_file_path: Annotated[str, typer.Argument(
        help="The path to the Jenga build file.")],
    build_order_file_path: Annotated[str, typer.Argument(
        help="The path to the Jenga build order file.")],
...
def extract_some_zipped_mods_to_extracted_mods(
    archive_name_part: Annotated[str, typer.Argument(help=(
...
def overwrite_game_dir_with_clean_source_dir(
    game: Annotated[str, typer.Argument(help=
        "The game alias to overwrite the game directory for. E.g. 'BG2EE'."
    )],
    eet: Annotated[bool, typer.Option(
        "--eet",
        help=(
